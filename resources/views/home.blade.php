...
<nav class="site-navigation position-relative text-right" role="navigation">
    <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
        ...
        <li><a href="#activites" class="nav-link">Activites</a></li>
          ...
          <table class="table  table-bordered">
            ...
            <tr>
              ...
              <td>
                ...
                @if($m->jour == $j)
                {{$m->nom}} {{$m->prenom}} :<span style="margin:1em">{{$i->heurDebut}} - {{$i->heurFin}}</span><hr>
                @endif
                @endforeach
              </td>
            </tr>
...
<br>
    ...
    <div>
      {{-- <livewire:table-inline-edit data="{{ $data }}" /> --}}
  </div>
</div>
@endsection
