...
<div class="intro-section" id="home" style="background-color: #eee ;">
      <div class="container">
        <div class="row align-items-center">
          ...
          <form action="/ajouterActivites" method="post" style="margin:20px">
                @csrf
                <div class="form-group">  
                  <label for="exampleInputEmail1">Nom de l'activite</label>
                  <input type="text" class="form-control" name="nom" required style="margin:20px">
                </div>
